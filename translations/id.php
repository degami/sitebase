...
return [
    ...
    "Commerce Dashboard" => "Dasbor Perdagangan",
    "Lifetime" => "Seumur hidup",
    "Last year" => "Tahun lalu",
    "Last month" => "Bulan lalu",
    "Last week" => "Minggu lalu",
    "Revenue (Gross)" => "Pendapatan (Kotor)",
    "Net Income" => "Pendapatan bersih",
    "Average Order Value" => "Nilai pesanan rata-rata",
    "Products Sold" => "Produk terjual",
    "Avg per order: %s" => "Rata-rata per pesanan: %s",
    "Unique Customers" => "Pelanggan unik",
    "Orders per day" => "Pesanan per hari",
    "Shipping total" => "Total pengiriman",
    "Tax collected" => "Pajak yang dikumpulkan",
    "Discounts given" => "Diskon yang diberikan",
    "Most used payment method" => "Metode pembayaran paling sering digunakan",
    "Top %d best sellers" => "%d produk terlaris",
    "Sold quantity" => "Jumlah terjual",
    "In Stock quantity" => "Jumlah stok",
    "Order Shipments" => "Pengiriman pesanan",
    "Shipping Method" => "Metode pengiriman",
    "Shipment Code" => "Kode pengiriman",
    "Location" => "Lokasi",
