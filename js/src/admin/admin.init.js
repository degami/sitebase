...
const Tour = Shepherd.Tour || (Shepherd.default ? Shepherd.default.Tour : null);
if (!Tour) {
    throw new Error("Shepherd.Tour non è stato trovato. Controlla la configurazione Rollup/CommonJS.");
}
        ...
        return this.each(function() {
            ...
            */
            ...
            $('.with-enable-switch').each(function() {
                const $element = $(this);
                const $switchHtml = '<label class="switch mr-1"><input type="checkbox" data-target-selector="#' + $element.attr('id') + '" id="' + $element.attr('id') + '-enabler" value="" class="paginator-items-choice" style="width: 50px"><span class="slider"></span></label>';
                                ...
                                buttons: [
                                    {
                                        ...
                                        text: __('Previous'),
                                        classes: 'shepherd-button-secondary shepherd-button-prev'
                                    },
                                    {
                                        action: function() {
                                            this.next();
