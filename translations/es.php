...
return [
    ...
    "Top %d best sellers" => "Top %d más vendidos",
    "Sold quantity" => "Cantidad vendida",
    "In Stock quantity" => "Cantidad en stock",
    "Order Shipments" => "Envíos de pedidos",
    "Shipping Method" => "Método de envío",
    "Shipment Code" => "Código de envío",
    "Location" => "Ubicación",
    "Product Stocks" => "Inventario de productos",
