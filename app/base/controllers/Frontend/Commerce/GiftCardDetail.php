 ...
 */
class GiftCardDetail extends FrontendPageWithObject
{
    use FormPageTrait;
    ...
    {
        return 'commerce/giftcard_detail';
    }
    ...
    {
        if (!($this->getObject() instanceof GiftCard && $this->getObject()->isLoaded())) {
    ...
    {
        return parent::getHtmlBodyClasses() . ' giftcard-' . $this->getObject()->id;
    }
    ...
    protected function beforeRender() : BasePage|Response
    {
        ...
        if (isset($route_data['id'])) {
            $this->setObject($this->containerCall([GiftCard::class, 'load'], ['id' => $route_data['id']]));
