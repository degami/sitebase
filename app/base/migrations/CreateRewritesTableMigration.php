 ...
 */
class CreateRewritesTableMigration extends DBMigration
{
    /**
    ...
    public function addDBTableDefinition(Table $table): Table
    {
        $table->addColumn('id', 'INT', null, ['UNSIGNED'], false)
            ...
            ->addIndex('url_unique', 'url', Index::TYPE_UNIQUE)
            ->addForeignKey('fk_rewrite_website_id', ['website_id'], 'website', ['id'])
            ->addForeignKey('fk_rewrite_owner_id', ['user_id'], 'user', ['id'])
            ->addForeignKey('fk_rewrite_language_locale', ['locale'], 'language', ['locale'])
