...
return [
    ...
    '%s is already existing into destination path' => '%s existe déjà dans le chemin de destination',
    'Destination folder %s is not existing' => 'Le dossier de destination %s n’existe pas',
    '%s is not a folder' => '%s n’est pas un dossier',
    'Error creating directory %s into %s' => 'Erreur lors de la création du répertoire %s dans %s',
    'Error copying %s into %s' => 'Erreur lors de la copie de %s dans %s',
    'Error moving %s into %s' => 'Erreur lors du déplacement de %s dans %s',
    'Copy' => 'Copier',
    'Cut' => 'Couper',
    'Paste' => 'Coller',
    '%d elements copied' => '%d éléments copiés',
    '%d elements cut' => '%d éléments coupés',
    'Operation complete' => 'Opération terminée',
    'Error during operation: %s' => 'Erreur pendant l’opération : %s',
    'Error' => 'Erreur',
    'Success' => 'Succès',
    'Warning' => 'Avertissement',
    'Notice' => 'Remarque',
    'Ctrl+Click on two versions to compare them' => 'Ctrl+clic sur deux versions pour les comparer',
    'Restore' => 'Restaurer',
    'Remove' => 'Supprimer',
    'Pages' => 'Pages',
    ...
    'Apply' => 'Appliquer',
    'Applied Discounts' => 'Réductions appliquées',
    'Amount' => 'Montant',
    ...
    'Choose an existing Address' => 'Choisir une adresse existante',
    'or create a new one' => 'ou en créer une nouvelle',
    'Continue' => 'Continuer',
    'Order Review & Payment' => 'Revue de commande et paiement',
    'Billing' => 'Facturation',
    'Shipping' => 'Livraison',
    'Summary' => 'Résumé',
    ...
    'Fake (Test) Payment' => 'Paiement factice (test)',
    'PayPal' => 'PayPal',
    'Scalapay' => 'Scalapay',
    'Stripe' => 'Stripe',
    'Please make the bank transfer using the following IBAN' => 'Veuillez effectuer le virement bancaire en utilisant l’IBAN suivant',
    'Specify the following bank transfer reason' => 'Précisez la raison du virement suivante',
    'Transfer Reference Code' => 'Code de référence du virement',
    ...
    'Refresh Methods' => 'Actualiser les méthodes',
    'Matrix Rate' => 'Tarif matriciel',
    'Shipping costs: %s' => 'Frais d’expédition : %s',
    'ZIP code pattern (eg: 00*,10*,*)' => 'Modèle de code postal (ex : 00*,10*,*)',
    'Weight from (kg)' => 'Poids de (kg)',
    'Weight to (kg)' => 'Poids à (kg)',
    'Cost' => 'Coût',
    ...
    'Your cart is eligible to Free Shipping' => 'Votre panier est éligible à la livraison gratuite',
    "Commerce Dashboard" => "Tableau de bord commerce",
    "Lifetime" => "Durée de vie",
    "Last year" => "L'année dernière",
    "Last month" => "Le mois dernier",
    "Last week" => "La semaine dernière",
    "Revenue (Gross)" => "Revenu (Brut)",
    "Net Income" => "Revenu net",
    "Average Order Value" => "Valeur moyenne de commande",
    "Products Sold" => "Produits vendus",
    "Avg per order: %s" => "Moyenne par commande : %s",
    "Unique Customers" => "Clients uniques",
    "Orders per day" => "Commandes par jour",
    "Shipping total" => "Total livraison",
    "Tax collected" => "Taxes collectées",
    "Discounts given" => "Réductions accordées",
    "Most used payment method" => "Méthode de paiement la plus utilisée",
    "Top %d best sellers" => "Top %d meilleures ventes",
    "Sold quantity" => "Quantité vendue",
    "In Stock quantity" => "Quantité en stock",
    "Order Shipments" => "Expéditions de commandes",
    "Shipping Method" => "Méthode d'expédition",
    "Shipment Code" => "Code d'expédition",
