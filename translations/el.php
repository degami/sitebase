...
return [
    ...
    "Commerce Dashboard" => "Πίνακας ελέγχου εμπορίου",
    "Lifetime" => "Διάρκεια ζωής",
    "Last year" => "Πέρυσι",
    "Last month" => "Τον προηγούμενο μήνα",
    "Last week" => "Την προηγούμενη εβδομάδα",
    "Revenue (Gross)" => "Έσοδα (Μικτά)",
    "Net Income" => "Καθαρό εισόδημα",
    "Average Order Value" => "Μέση αξία παραγγελίας",
    "Products Sold" => "Πωληθέντα προϊόντα",
    "Avg per order: %s" => "Μέσος όρος ανά παραγγελία: %s",
    "Unique Customers" => "Μοναδικοί πελάτες",
    "Orders per day" => "Παραγγελίες ανά ημέρα",
    "Shipping total" => "Σύνολο αποστολής",
    "Tax collected" => "Φόρος που συλλέχθηκε",
    "Discounts given" => "Εκπτώσεις που δόθηκαν",
    "Most used payment method" => "Η πιο χρησιμοποιημένη μέθοδος πληρωμής",
    "Top %d best sellers" => "Κορυφαία %d σε πωλήσεις",
    "Sold quantity" => "Ποσότητα που πουλήθηκε",
    "In Stock quantity" => "Ποσότητα σε απόθεμα",
    "Order Shipments" => "Αποστολές παραγγελιών",
    "Shipping Method" => "Μέθοδος αποστολής",
    "Shipment Code" => "Κωδικός αποστολής",
    "Location" => "Τοποθεσία",
