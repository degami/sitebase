...
return [
    ...
    "Lifetime" => "Gesamtzeitraum",
    "Last year" => "Letztes Jahr",
    "Last month" => "Letzter Monat",
    "Last week" => "Letzte Woche",
    "Revenue (Gross)" => "Umsatz (Brutto)",
    "Net Income" => "Nettoeinnahmen",
    "Average Order Value" => "Durchschnittlicher Bestellwert",
    "Products Sold" => "Verkaufte Produkte",
    "Avg per order: %s" => "Durchschnitt pro Bestellung: %s",
    "Unique Customers" => "Eindeutige Kunden",
    "Orders per day" => "Bestellungen pro Tag",
    "Shipping total" => "Gesamtversand",
    "Tax collected" => "Eingezogene Steuern",
    "Discounts given" => "Gewährte Rabatte",
    "Most used payment method" => "Meistgenutzte Zahlungsmethode",
    "Top %d best sellers" => "Top %d Bestseller",
    "Sold quantity" => "Verkaufte Menge",
    "In Stock quantity" => "Lagerbestand",
    "Order Shipments" => "Bestelllieferungen",
    "Shipping Method" => "Versandart",
    "Shipment Code" => "Sendungscode",
    "Location" => "Standort",
