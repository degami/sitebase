...
use App\Base\AI\Models\Perplexity as PerplexityModel;
 ...
 * Perplexity Admin
 */
class Perplexity extends AIAdminJsonPage
{
    /**
    ...
    {
        return PerplexityModel::isEnabled();
    }
    ...
    protected function getJsonData(): array
    {
        ...
        if (empty($prompt)) {
            throw new Exception("Missing Perplexity prompt text");
        }
