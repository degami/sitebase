...
return [
    ...
    'Your cart is eligible to Free Shipping' => 'আপনার কার্ট বিনামূল্যে শিপিংয়ের জন্য যোগ্য',
    "Commerce Dashboard" => "কমার্স ড্যাশবোর্ড",
    "Lifetime" => "আজীবন",
    "Last year" => "গত বছর",
    "Last month" => "গত মাস",
    "Last week" => "গত সপ্তাহ",
    "Revenue (Gross)" => "রাজস্ব (মোট)",
    "Net Income" => "নিট আয়",
    "Average Order Value" => "গড় অর্ডার মান",
    "Products Sold" => "পণ্য বিক্রি হয়েছে",
    "Avg per order: %s" => "প্রতি অর্ডারে গড়: %s",
    "Unique Customers" => "একক গ্রাহক",
    "Orders per day" => "প্রতিদিন অর্ডার",
    "Shipping total" => "মোট শিপিং",
    "Tax collected" => "সংগৃহীত কর",
    "Discounts given" => "প্রদান করা ছাড়",
    "Most used payment method" => "সর্বাধিক ব্যবহৃত পেমেন্ট পদ্ধতি",
    "Top %d best sellers" => "শীর্ষ %d সর্বাধিক বিক্রয়",
    "Sold quantity" => "বিক্রিত পরিমাণ",
    "In Stock quantity" => "স্টকে থাকা পরিমাণ",
    "Order Shipments" => "অর্ডার চালান",
    "Shipping Method" => "শিপিং পদ্ধতি",
    "Shipment Code" => "চালান কোড",
    "Location" => "অবস্থান",
    "Product Stocks" => "পণ্যের স্টক",
